...
: ${AMENT_CURRENT_PREFIX:="/astra/ros2_ws/install/astra_interfaces"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/astra_interfaces/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/astra_interfaces/environment/path.sh"
